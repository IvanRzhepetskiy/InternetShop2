        ...
        if form.is_valid():
            ...
            for name, value in data.items():
                if name.startswith("product_in_basket_"):
                    ...
                    product_in_basket = ProductBasket.objects.get(id=product_in_basket_id)
                    print(type(value))
                    ...
                    ProductOrder.objects.create(product=product_in_basket.product, nmb = product_in_basket.nmb,
